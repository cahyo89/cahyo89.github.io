...
$(function () {
  ...
  var radialBarChartEl = document.querySelector('#radialbar-chart'),
    radialBarChartConfig = {
      ...
      colors: [chartColors.donut.series3, chartColors.donut.series1, chartColors.donut.series5],
      plotOptions: {
        radialBar: {
          size: 185,
          hollow: {
      ...
      series: [80, 50, 35],
      labels: [ "Corporate Planning & Business Performance Analysis", 'Investment', 'Shares']
    };
